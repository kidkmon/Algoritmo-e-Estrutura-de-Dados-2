...
from .tables.equipe7.processo.processo_interface import ProcessoInterface


class Zelda(FuncionarioInterface, UsuarioInterface, SetorInterface, PerfilInterface, FuncionalidadeInterface, SistemaInterface, ProcessoInterface):
